...
## Project Structure
    ...
    ├── square_wildflower_d_78084  # Django project configurations
...
1. Clone this repo and `cd square_wildflower_d_78084`
...
2. Clone this repo and `cd square_wildflower_d_78084`
